...
const businessesData = [
  {
    ...
    htmlFile: "business-sayansk-meat.html", // ← ИСПРАВЛЕНО
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: "Производство трикотажа и реализация трикотажных изделий высокого качества.",
    location: "Абакан",
    founded: "2014",
    employees: "50-100",
    image: "img/ат.png",
    htmlFile: "business-abakan-tricotage.html", // ← ИСПРАВЛЕНО
  },
]
